    ...
    <>
      <section className="min-h-screen flex flex-col items-center justify-center mt-16 md:mt-10">
        <div className="w-full max-w-6xl rounded-xl p-8">
          ...
          <div className="flex items-center justify-center bg-gray-200 rounded-full w-72 h-10 p-1 mx-auto">
            <button
              className={`w-1/3 h-full rounded-full transition-all ${
            ...
            <button
              className={`w-1/3 h-full rounded-full transition-all ${
                selectedOption === "MACOS"
                  ? "bg-blue-600 text-white"
                  : "text-gray-600"
              }`}
              onClick={() => setSelectedOption("MACOS")}
            >
              MacOS
            </button>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            ...
            <div className="w-full md:w-1/3 lg:w-1/4 bg-gray-100 rounded-lg p-6">
              ...
              <ul className="text-gray-600 mb-4">
                ...
                <li className="flex items-center mb-2">
                  <span className="mr-2 text-green-500">✔</span> 100 Passwords
                  Each
                </li>
                <li className="flex items-center mb-2">
